# Sistemski obrasci zataškavanja DORH-a / USKOK-a i pravna zaštita u slučaju Koromačno

**Na temelju objave Dalije Orešković o postupku hrvatskih državnih tijela i pravosuđa**

Ova analiza razotkriva dva sistemska obrasca postupanja tijela državne vlasti i pravosuđa (DORH / USKOK / inspekcije) koji su identični metodama s kojima se susrećemo u slučaju Koromačno.

---

## I. Dva ključna obrasca zataškavanja

### Obrazac A: Skrivanje opasnih ekoloških izvješća (Ličko tlo/vode vs. Koromačno)

**Kako funkcionira:** Kada službene analize utvrde prisutnost kancerogenih tvari u okolišu (bilo u tlu i vodama Like, ili kroz dvostruka prekoračenja TOC-a i opasnih plinova u Koromačnu), nadležna tijela izvješća stavljaju "pod tepih".

**Cilj:** Spriječiti reakciju javnosti, uskratiti dokaze građanima i onemogućiti pokretanje tužbi ili inspekcijskih blokada.

### Obrazac B: Proceduralna "crna rupa" i skrivanje odbačaja (slučaj Maja Đerek vs. DORH/ODO Pula)

**Kako funkcionira:** Kaznena prijava se zaprimi, drži u ladici godinama, a potom tiho odbaci. Kada građani ili zastupnici zatraže Rješenje o odbačaju s obrazloženjem (kako bi vidjeli koje je dokaze DORH "vještačio"), nastupa ping-pong prebacivanja nadležnosti (USKOK ↔ Ministarstvo ↔ Trgovačka društva) i uskraćivanje dokumenta.

**Cilj:** Onemogućiti podnositelju prijave ili javnosti da uoči proceduralne pogreške, uloži prigovor ili preuzme samostalni kazneni progon.

---

## II. Kako ove spoznaje iskoristiti u strategiji za Koromačno?
...
**Akcija:** Kompletirani Master dosje (`Zeljk018Bratic/dosje-koromacno`) i službene audio transkripte OV Raša (gdje je potvrđeno dvostruko prekoračenje TOC-a) pošaljite direktno saborskim zastupnicima i Odboru za zaštitu okoliša. Neka oni putem zastupničkih pitanja prisile DORH i Državni inspektorat da se očituju zašto postrojenje radi unatoč zapisničkim dokazima o prekoračenju.
